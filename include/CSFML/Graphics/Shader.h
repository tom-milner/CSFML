...
/// very specific stuff to implement that CSFML doesn't support,
...
/// used when drawing CSFML entities. It must be used only if you
...
/// code or CSFML will result in a context switch.
///
