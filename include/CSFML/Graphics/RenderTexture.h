...
///
/// This function can be used when you mix CSFML drawing
/// and direct OpenGL rendering. Combined with popGLStates,
/// it ensures that:
/// \li CSFML's internal states are not messed up by your OpenGL code
/// \li your OpenGL states are not modified by a call to a CSFML function
///
...
/// states needed by CSFML are set, so that subsequent sfRenderTexture_draw*()
